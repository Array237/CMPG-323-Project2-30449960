...
namespace Project2_30449960.Controller
{
    ...
    public class DevicesController : ControllerBase
    {
        ...
        public DevicesController(Project2_DB_30449960Context context)
        {
            _context = context;
        }
        ...
        {
            var device = await _context.Device.Where(i => i.ZoneId == id).ToListAsync();
